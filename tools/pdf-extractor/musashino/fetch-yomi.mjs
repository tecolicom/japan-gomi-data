// 武蔵野市の町名 → 読み(yomi)・町字ID(machiaza_id): デジタル庁 ABR 町字マスター東京都版 (pref13) から
// 武蔵野市 (lg_code 132039) 分を cache/abr-town.json へ。build.mjs が areas の丁目展開・
// yomi 付与・machiaza_id 付与に使う (西東京・朝霞・横浜・倉敷と同型)。
...
console.log(`ABR 武蔵野市 町字 ${towns.length} 件 -> cache/abr-town.json`);
