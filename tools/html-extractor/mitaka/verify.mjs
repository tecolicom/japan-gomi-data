...
const PDF_SAMPLES = {
  ...
  '095682': {
    // 2026年4月・5月 (attach_95682_2.pdf)。年度始めと GW を含む層。
    // 5/4・5/5・5/6 の祝日も通常どおり収集していることを画像で確認した。
    '2026-04-01': ['plastic', 'hazardous', 'non_burnable'],
    '2026-04-02': ['burnable'],
    '2026-04-03': ['pet_bottle'],
    '2026-04-06': ['burnable'],
    '2026-04-07': ['cloth', 'paper'],
    '2026-04-08': ['plastic', 'hazardous'],
    '2026-04-09': ['burnable'],
    '2026-04-10': ['beverage_can', 'glass_bottle'],
    '2026-04-13': ['burnable'],
    '2026-04-14': ['cloth', 'paper'],
    '2026-04-15': ['plastic', 'hazardous', 'non_burnable'],
    '2026-04-16': ['burnable'],
    '2026-04-17': ['pet_bottle'],
    '2026-04-20': ['burnable'],
    '2026-04-21': ['cloth', 'paper'],
    '2026-04-22': ['plastic', 'hazardous'],
    '2026-04-23': ['burnable'],
    '2026-04-24': ['beverage_can', 'glass_bottle'],
    '2026-04-27': ['burnable'],
    '2026-04-28': ['cloth', 'paper'],
    '2026-04-29': ['plastic', 'hazardous'],
    '2026-04-30': ['burnable'],
    '2026-05-01': ['pet_bottle'],
    '2026-05-04': ['burnable'],
    '2026-05-05': ['cloth', 'paper'],
    '2026-05-06': ['plastic', 'hazardous', 'non_burnable'],
    '2026-05-07': ['burnable'],
    '2026-05-08': ['beverage_can', 'glass_bottle'],
    '2026-05-11': ['burnable'],
    '2026-05-12': ['cloth', 'paper'],
    '2026-05-13': ['plastic', 'hazardous'],
    '2026-05-14': ['burnable'],
    '2026-05-15': ['pet_bottle'],
    '2026-05-18': ['burnable'],
    '2026-05-19': ['cloth', 'paper'],
    '2026-05-20': ['plastic', 'hazardous', 'non_burnable'],
    '2026-05-21': ['burnable'],
    '2026-05-22': ['beverage_can', 'glass_bottle'],
    '2026-05-25': ['burnable'],
    '2026-05-26': ['cloth', 'paper'],
    '2026-05-27': ['plastic', 'hazardous'],
    '2026-05-28': ['burnable'],
    '2026-05-29': [],
